<?php
    ...
    $twelfth_marks = $_POST['12th_marks'];
    $cgpa = $_POST['cgpa'];
    ...
    }else
    {
        ...
        $s = "update academic_details set 10th_marks = '$tenth_marks',12th_marks = '$twelfth_marks', cgpa = '$cgpa',arrears = '$arrears' where student_id = '$student_id'";
